...
//    		encoding = "GBK";
    ...
    public static String post(String url, Map params, String charset){  
        return invokeUrl(url,params,null,0,0,charset,HttpMethod.POST);  
    }  
    
    public static String postUtf_8(String url, Map params){  
        return invokeUrl(url,params,null,0,0,"UTF-8",HttpMethod.POST);  
    }  
    
    public static String postGbk(String url, Map params){  
        return invokeUrl(url,params,null,0,0,"gbk",HttpMethod.POST);  
    }  
...
//    	(String url, Map params, Map<String,String> headers, int connectTimeout, int readTimeout, String encoding, HttpMethod method)
        return invokeUrl(url,null,null,0,0,null,HttpMethod.GET);  
    } 
    
    public static String get(String url,String encoding){
//    	(String url, Map params, Map<String,String> headers, int connectTimeout, int readTimeout, String encoding, HttpMethod method)
        return invokeUrl(url,null,null,0,0,encoding,HttpMethod.GET);  
    }  
